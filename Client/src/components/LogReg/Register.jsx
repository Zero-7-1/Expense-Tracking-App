      ...
      <main className="w-full h-screen flex self-center place-content-center place-items-center">
        <div className="w-96 text-gray-600 space-y-5 p-4 shadow-xl border rounded-xl">
          <div className="text-center mb-6">
            <div className="mt-2">
              <h3 className="text-gray-800 text-xl font-semibold sm:text-2xl">Register & Sign in</h3>
            </div>
          </div>
          <form onSubmit={onSubmit} className="space-y-4">
            ...
            >
              {isRegistering ? 'Signing Up...' : 'Sign in'}
            </button>
            <div className="text-sm text-center">
              Signs you in instantly, you could use dummy data if you are concerned, your data will be removed 
              within few days ! {' '}
